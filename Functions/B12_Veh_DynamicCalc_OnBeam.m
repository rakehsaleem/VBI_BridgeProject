...
for veh_num = 1:Veh(1).Event.num_veh
    ...
    % -- Force Matrix --
    F_ext = (Veh(veh_num).Prop.kTi'*ones(1,Calc.Solver.num_t_beam)).*Sol.Veh(veh_num).Under.h + ...
            (Veh(veh_num).Prop.cTi'*ones(1,Calc.Solver.num_t_beam)).*Sol.Veh(veh_num).Under.hd;
